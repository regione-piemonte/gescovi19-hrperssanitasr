...
class SearchPanelSimple extends SearchPanel {
	...
	{	
		...
		$searchOpt_mess = ($searchPanelAttrs['srchOptShowStatus'] ? "Nascondi le opzioni di ricerca" : "Mostra le opzioni di ricerca");
		...
		$searchforAttrs.= ' placeholder="'."ricerca".'"';
	...
	function DisplaySearchPanel()
	{
		...
		$showHideOpt_mess = $this->srchPanelAttrs['ctrlTypeComboStatus'] ? "Nascondi opzioni" : "Mostra opzioni";		
