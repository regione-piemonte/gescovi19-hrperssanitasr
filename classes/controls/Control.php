...
class EditControl
{
	...
	function __construct($field, $pageObject, $id, $connection)
	{
		...
		$this->searchOptions[EQUALS] = "Uguale";
		$this->searchOptions[STARTS_WITH] = "Incomincia per";
		$this->searchOptions[MORE_THAN] = "Più di";
		$this->searchOptions[LESS_THAN] = "Meno di";
		$this->searchOptions[BETWEEN] = "Tra";
		$this->searchOptions[EMPTY_SEARCH] = "Vuoto";
		$this->searchOptions[NOT_CONTAINS] = "Non contiene";
		$this->searchOptions[NOT_EQUALS] = "Non è uguale a";
		$this->searchOptions[NOT_STARTS_WITH] = "Non inizia per";
		$this->searchOptions[NOT_MORE_THAN] = "Non è maggiore di";
		$this->searchOptions[NOT_LESS_THAN] = "Non è minore di";
		$this->searchOptions[NOT_BETWEEN] = "Non è compreso";
		$this->searchOptions[NOT_EMPTY] = "Non è vuoto";
