...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "hostname.covidhr_t_fabbisogno" ] = array( "url" => "covidhr_t_fabbisogno", "type" => 0 );
	$projectEntitiesReverse[ "covidhr_t_fabbisogno" ] = "hostname.covidhr_t_fabbisogno";
	$projectEntities[ "hostname.area" ] = array( "url" => "area", "type" => 0 );
	$projectEntitiesReverse[ "area" ] = "hostname.area";
	$projectEntities[ "hostname.ente" ] = array( "url" => "ente", "type" => 0 );
	$projectEntitiesReverse[ "ente" ] = "hostname.ente";
	$projectEntities[ "hostname.r_utente_area" ] = array( "url" => "r_utente_area", "type" => 0 );
	$projectEntitiesReverse[ "r_utente_area" ] = "hostname.r_utente_area";
	$projectEntities[ "hostname.r_utente_ente" ] = array( "url" => "r_utente_ente", "type" => 0 );
	$projectEntitiesReverse[ "r_utente_ente" ] = "hostname.r_utente_ente";
	$projectEntities[ "hostname.r_utente_profilo" ] = array( "url" => "r_utente_profilo", "type" => 0 );
	$projectEntitiesReverse[ "r_utente_profilo" ] = "hostname.r_utente_profilo";
	$projectEntities[ "hostname.d_area" ] = array( "url" => "d_area", "type" => 0 );
	$projectEntitiesReverse[ "d_area" ] = "hostname.d_area";
	$projectEntities[ "hostname.r_utente_struttura" ] = array( "url" => "r_utente_struttura", "type" => 0 );
	$projectEntitiesReverse[ "r_utente_struttura" ] = "hostname.r_utente_struttura";
	$projectEntities[ "hostname.utenti" ] = array( "url" => "utenti", "type" => 0 );
	$projectEntitiesReverse[ "utenti" ] = "hostname.utenti";
	$projectEntities[ "hostname.covidhr_t_fabbisogno_det" ] = array( "url" => "covidhr_t_fabbisogno_det", "type" => 0 );
	$projectEntitiesReverse[ "covidhr_t_fabbisogno_det" ] = "hostname.covidhr_t_fabbisogno_det";
	$projectEntities[ "hostname.covidhr_d_fabbisogno_personale_tipo" ] = array( "url" => "covidhr_d_fabbisogno_personale_tipo", "type" => 0 );
	$projectEntitiesReverse[ "covidhr_d_fabbisogno_personale_tipo" ] = "hostname.covidhr_d_fabbisogno_personale_tipo";
	$projectEntities[ "hostname.covidhr_d_fabbisogno_stato" ] = array( "url" => "covidhr_d_fabbisogno_stato", "type" => 0 );
	$projectEntitiesReverse[ "covidhr_d_fabbisogno_stato" ] = "hostname.covidhr_d_fabbisogno_stato";
}
