...
// where tab
	...
	protected function isProjectDB()
	{
		...
		if("hostname.covidhr_t_fabbisogno" == $this->chrt_array['tables'][0])
			return true;
		if("hostname.area" == $this->chrt_array['tables'][0])
			return true;
		if("hostname.ente" == $this->chrt_array['tables'][0])
			return true;
		if("hostname.r_utente_area" == $this->chrt_array['tables'][0])
			return true;
		if("hostname.r_utente_ente" == $this->chrt_array['tables'][0])
			return true;
		if("hostname.r_utente_profilo" == $this->chrt_array['tables'][0])
			return true;
		if("hostname.d_area" == $this->chrt_array['tables'][0])
			return true;
		if("hostname.r_utente_struttura" == $this->chrt_array['tables'][0])
			return true;
		if("hostname.utenti" == $this->chrt_array['tables'][0])
			return true;
		if("hostname.covidhr_t_fabbisogno_det" == $this->chrt_array['tables'][0])
			return true;
		if("hostname.covidhr_d_fabbisogno_personale_tipo" == $this->chrt_array['tables'][0])
			return true;
		if("hostname.covidhr_d_fabbisogno_stato" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
