...
{	
	...
	function addCommonHtml() 
	{
		...
		if($this->is508) {
			$this->body["begin"].= "<a href=\"#skipdata\" title=\""."Salta alla tabella dei dati"."\" class=\"".$this->makeClassName("s508")."\">"."Salta alla tabella dei dati"."</a>";
			$this->body["begin"].= "<a href=\"#skipmenu\" title=\""."Salta al menu"."\" class=\"".$this->makeClassName("s508")."\">"."Salta al menu"."</a>";
			$this->body["begin"].= "<a href=\"#skipsearch\" title=\""."Salta alla ricerca"."\" class=\"".$this->makeClassName("s508")."\">"."Salta alla ricerca"."</a>";
			$this->body["begin"].= "<a href=\"templates/helpshortcut.htm\" title=\""."Elenco delle scorciatoie"."\" class=\"".$this->makeClassName("s508")."\">"."Elenco delle scorciatoie"."</a>";
		}
...
//	normal mode row count
	...
	{ 
		...
		return $fName." ". ($desc ? "Dall'alto al basso" : "Dal basso all'alto");
	}
