...
class DB
{
	...
	protected static function _fillTablesList()
	{
		...
		if( "schemaname_at_hostname" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "area", "varname" => "schemaname_at_hostname_hostname_area", "altvarname" => "area", "connId" => "schemaname_at_hostname", "schema" => "hostname", "connName" => "hostname at hostname");
			$dalTables[$conn->connId][] = array("name" => "covidhr_d_fabbisogno_personale_tipo", "varname" => "schemaname_at_hostname_hostname_covidhr_d_fabbisogno_personale_tipo", "altvarname" => "covidhr_d_fabbisogno_personale_tipo", "connId" => "schemaname_at_hostname", "schema" => "hostname", "connName" => "hostname at hostname");
			$dalTables[$conn->connId][] = array("name" => "covidhr_d_fabbisogno_stato", "varname" => "schemaname_at_hostname_hostname_covidhr_d_fabbisogno_stato", "altvarname" => "covidhr_d_fabbisogno_stato", "connId" => "schemaname_at_hostname", "schema" => "hostname", "connName" => "hostname at hostname");
			$dalTables[$conn->connId][] = array("name" => "covidhr_t_fabbisogno", "varname" => "schemaname_at_hostname_hostname_covidhr_t_fabbisogno", "altvarname" => "covidhr_t_fabbisogno", "connId" => "schemaname_at_hostname", "schema" => "hostname", "connName" => "hostname at hostname");
			$dalTables[$conn->connId][] = array("name" => "covidhr_t_fabbisogno_det", "varname" => "schemaname_at_hostname_hostname_covidhr_t_fabbisogno_det", "altvarname" => "covidhr_t_fabbisogno_det", "connId" => "schemaname_at_hostname", "schema" => "hostname", "connName" => "hostname at hostname");
			$dalTables[$conn->connId][] = array("name" => "covidhr_v_dettaglio_fabbisogni", "varname" => "schemaname_at_hostname_hostname_covidhr_v_dettaglio_fabbisogni", "altvarname" => "covidhr_v_dettaglio_fabbisogni", "connId" => "schemaname_at_hostname", "schema" => "hostname", "connName" => "hostname at hostname");
			$dalTables[$conn->connId][] = array("name" => "d_area", "varname" => "schemaname_at_hostname_hostname_d_area", "altvarname" => "d_area", "connId" => "schemaname_at_hostname", "schema" => "hostname", "connName" => "hostname at hostname");
			$dalTables[$conn->connId][] = array("name" => "ente", "varname" => "schemaname_at_hostname_hostname_ente", "altvarname" => "ente", "connId" => "schemaname_at_hostname", "schema" => "hostname", "connName" => "hostname at hostname");
			$dalTables[$conn->connId][] = array("name" => "profilo", "varname" => "schemaname_at_hostname_hostname_profilo", "altvarname" => "profilo", "connId" => "schemaname_at_hostname", "schema" => "hostname", "connName" => "hostname at hostname");
			$dalTables[$conn->connId][] = array("name" => "r_utente_area", "varname" => "schemaname_at_hostname_hostname_r_utente_area", "altvarname" => "r_utente_area", "connId" => "schemaname_at_hostname", "schema" => "hostname", "connName" => "hostname at hostname");
			$dalTables[$conn->connId][] = array("name" => "r_utente_ente", "varname" => "schemaname_at_hostname_hostname_r_utente_ente", "altvarname" => "r_utente_ente", "connId" => "schemaname_at_hostname", "schema" => "hostname", "connName" => "hostname at hostname");
			$dalTables[$conn->connId][] = array("name" => "r_utente_profilo", "varname" => "schemaname_at_hostname_hostname_r_utente_profilo", "altvarname" => "r_utente_profilo", "connId" => "schemaname_at_hostname", "schema" => "hostname", "connName" => "hostname at hostname");
			$dalTables[$conn->connId][] = array("name" => "r_utente_struttura", "varname" => "schemaname_at_hostname_hostname_r_utente_struttura", "altvarname" => "r_utente_struttura", "connId" => "schemaname_at_hostname", "schema" => "hostname", "connName" => "hostname at hostname");
			$dalTables[$conn->connId][] = array("name" => "struttura", "varname" => "schemaname_at_hostname_hostname_struttura", "altvarname" => "struttura", "connId" => "schemaname_at_hostname", "schema" => "hostname", "connName" => "hostname at hostname");
			$dalTables[$conn->connId][] = array("name" => "utenti", "varname" => "schemaname_at_hostname_hostname_utenti", "altvarname" => "utenti", "connId" => "schemaname_at_hostname", "schema" => "hostname", "connName" => "hostname at hostname");
		}
	}
