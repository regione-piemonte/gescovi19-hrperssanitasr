...
class ConnectionManager
{
	...
	{
		return $this->byId( "schemaname_at_hostname" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 4;
		$data["connId"] = "schemaname_at_hostname";
		$data["connName"] = "hostname at hostname";
		$data["connStringType"] = "postgre";
		$data["connectionString"] = "postgre;schemaname_at_hostname;hostname;;;hostname;;1;"; //currently unused

		$this->_connectionsIdByName["schemaname at hostname"] = "schemaname_at_hostname";
		
		$data["connInfo"] = array();
		$data["ODBCUID"] = "hostname";
		$data["ODBCPWD"] = "";
		$data["leftWrap"] = "\"";
		$data["rightWrap"] = "\"";
		...
		$data["connInfo"][0] = "schemaname_at_hostname";
		$data["connInfo"][1] = "hostname";
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "hostname";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "Driver={PostgreSQL Unicode};Server=schemaname_at_hostname;Database=hostname;Uid=hostname;Pwd=;";
		// encription set
		...
		$connectionsData["schemaname_at_hostname"] = $data;
	...
	{
		$connectionsIds = array();
		$connectionsIds["hostname.covidhr_t_fabbisogno"] = "schemaname_at_hostname";
		$connectionsIds["hostname.area"] = "schemaname_at_hostname";
		$connectionsIds["hostname.ente"] = "schemaname_at_hostname";
		$connectionsIds["hostname.r_utente_area"] = "schemaname_at_hostname";
		$connectionsIds["hostname.r_utente_ente"] = "schemaname_at_hostname";
		$connectionsIds["hostname.r_utente_profilo"] = "schemaname_at_hostname";
		$connectionsIds["hostname.d_area"] = "schemaname_at_hostname";
		$connectionsIds["hostname.r_utente_struttura"] = "schemaname_at_hostname";
		$connectionsIds["hostname.utenti"] = "schemaname_at_hostname";
		$connectionsIds["hostname.covidhr_t_fabbisogno_det"] = "schemaname_at_hostname";
		$connectionsIds["hostname.covidhr_d_fabbisogno_personale_tipo"] = "schemaname_at_hostname";
		$connectionsIds["hostname.covidhr_d_fabbisogno_stato"] = "schemaname_at_hostname";
